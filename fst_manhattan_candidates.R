...
manhattan_plot <- ggplot(fst, aes(x = BPcum, y = WEIR_AND_COCKERHAM_FST)) +
  ...
  ggtitle("FST Manhattan Plot with Candidate SNPs Highlighted")

ggsave("FST_Manhattan_candidates.png", plot = manhattan_plot, width = 12, height = 6)
